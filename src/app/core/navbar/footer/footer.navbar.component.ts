...
import {ILanguageOptions, ICurrencyOptions} from "../../../shared/interfaces";
...
export class FooterNavbarComponent implements OnInit, OnDestroy {
    ...
    selectedLanguage: ILanguageOptions;

    currencyOptions: ICurrencyOptions[];
    selectedCurrency: ICurrencyOptions;
    ...
    ngOnInit() {
        ...
        this.selectedLanguage = this.languageOptions.find(x => x.localeName === 'en');
        ...
        this.selectedCurrency = this.currencyOptions.find(x => x.currencyValue === 'USD');
    }
