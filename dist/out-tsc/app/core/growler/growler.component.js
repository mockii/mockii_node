...
var GrowlerComponent = /** @class */ (function () {
    ...
    */
    GrowlerComponent.prototype.growl = function (message, growlType) {
        this.growlCount++;
        var bootstrapAlertType = GrowlerMessageType[growlType].toLowerCase();
    ...
    GrowlerComponent = __decorate([
        ...
        __metadata("design:paramtypes", [GrowlerService])
    ], GrowlerComponent);
    return GrowlerComponent;
}());
export { GrowlerComponent };
...
//# sourceMappingURL=/Users/rakeshchouhan/WebstormProjects/mockii_node/src/app/core/growler/growler.component.js.map